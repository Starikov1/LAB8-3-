...
$Passport = $_POST['Passport']; $TaxCode = $_POST['TaxCode']; $department_id_worker = $_POST['department_id_worker'];

$sql = "INSERT INTO Director_Other (Passport, TaxCode, department_id_worker) VALUES ('$Passport', '$TaxCode', '$department_id_worker' )";
